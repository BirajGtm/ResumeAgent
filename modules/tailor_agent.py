...
2.  **OBJECTIVE/SUMMARY REWRITING:** If a section has been identified as an 'Objective' or 'Summary' (as per CRITICAL REQUIREMENT 1.1), it **must be entirely rewritten** to be a concise, powerful, and JD-aligned. This section should immediately highlight the candidate's 2-3 most compelling qualifications and career aspirations *as they relate directly to the target role described in the JD*. It should act as a powerful initial pitch. If no such section is present or identified, do not attempt this specific transformation.
